...
time = WebUI.callTestCase(findTestCase('ReadData/GetTime'), [('shortTime') : shortTime], FailureHandling.STOP_ON_FAILURE)

WebUI.selectOptionByLabel(findTestObject('Altur/newVehicleRequestPage/drpHour'), time.hour, false)
