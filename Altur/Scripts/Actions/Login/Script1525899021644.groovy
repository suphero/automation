...
WebUI.waitForElementVisible(findTestObject('Altur/newVehicleRequestPage/infoWindowCloseButton'), 5000)

WebUI.click(findTestObject('Altur/newVehicleRequestPage/infoWindowCloseButton'))
